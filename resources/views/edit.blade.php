...
@section('section1')
    <section class="add-article">
        <div class="container ">
            <h1 class="text-center title-blue">Edit blog</h1>
        </div>
    </section>
@endsection
@section('section2')
                    ...
                    <div class="card-body">
                        <form method="POST" action="/post/edit/{{$post->slug}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="body" id="body" class="form-control @error('title') is-invalid @enderror" required autocomplete="body" autofocus>{{$post->body}}</textarea>
                                    @error('body')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
